...
var require_cjs = __commonJS({
  "../../../node_modules/deepmerge/dist/cjs.js"(exports, module) {
    ...
    function deepmerge2(target, source2, options2) {
      options2 = options2 || {};
...
var __objRest$1 = (source2, exclude) => {
  ...
  for (var prop2 in source2)
    if (__hasOwnProp$2.call(source2, prop2) && exclude.indexOf(prop2) < 0)
      target[prop2] = source2[prop2];
  if (source2 != null && __getOwnPropSymbols$2)
    for (var prop2 of __getOwnPropSymbols$2(source2)) {
      if (exclude.indexOf(prop2) < 0 && __propIsEnum$2.call(source2, prop2))
        target[prop2] = source2[prop2];
    }
  return target;
};
...
var getLocaleFromHash = (hash2) => {
  if (typeof window === "undefined")
    return null;
  return getFromQueryString(window.location.hash.substr(1), hash2);
};
...
var $format = derived2([$locale, $dictionary], () => formatMessage);
var $formatTime = derived2([$locale], () => formatTime);
var $formatDate = derived2([$locale], () => formatDate);
var $formatNumber = derived2([$locale], () => formatNumber);
var $getJSON = derived2([$locale, $dictionary], () => getJSON);
